...
def details(index):
    ...
    # proses foto
    img = Image.open("./assets/" + hunians[index].get_photo())
...
def landing():
    ...
    # label nya
    label = Label(root, text="Selamat datang", font=('Poppins', 13, 'bold'))
    label.pack()

    # setting foto
    img = Image.open("./assets/logo13.png")
    ...
    button = Button(root, text='Halaman Detail',
                    font=('Poppins', 10), command=detail)
